...
from ..errors import FileOperatorError, UserCancelledError
...
_hresult_to_exception = {
    ...
    FileOperationResult.E_DRIVE_NOT_FOUND: NotADirectoryError,
    ...
    # NOTE: FileNoteound handled by parse_name
}
